...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setServerError('የመግቢያ ስህተት፡ ' + error.message);
    }
  };
  ...
  return (
    <div className="max-w-md p-6 mx-auto mt-20 bg-white rounded-lg shadow-lg dark:bg-gray-900/30 dark:backdrop-blur-md dark:border dark:border-gray-500/20 animate-slide-in">
      <h2 className="mb-6 text-2xl font-bold text-center text-gray-900 dark:text-white">ግባ</h2>
      ...
      <p className="mt-4 text-center text-gray-600 dark:text-gray-300">
        መለያ የለህም?{' '}
        <a href="/register" className="text-blue-600 hover:underline dark:text-cyan-400">ተመዝገብ</a>
      </p>
    </div>
  );
}
